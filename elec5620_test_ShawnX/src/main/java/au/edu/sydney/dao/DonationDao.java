...
public class DonationDao {
    ...
    public int saveDonation(Donation donation) {
        ...
        int cid=donation.getId();
        return cid;
    }

	public void deleteDonationById(int i) {
		 sessionFactory.getCurrentSession().createQuery("delete Donation where id=?").setParameter(0, i).executeUpdate();
	}
