...
<body>
<h1>Invoke the camera first, then take a picture and submit.</h1>
<h2>The image will be delete automaticaly when you log out.</h2>
	<video id="video" autoplay="" style='width: 640px; height: 480px'></video>
	<button id="start">Invoke the Camera</button>
	<button id='picture'>Take a Photo</button>
	<button onclick="window.location.href='FaceLogining'" type="button">Login</button>
