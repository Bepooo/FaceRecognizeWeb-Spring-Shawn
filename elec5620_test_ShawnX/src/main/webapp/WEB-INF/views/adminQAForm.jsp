							...
							<form:form method="POST" modelAttribute="qa">
								...
								<table>
									<tr>
										...
										<td><form:input path="question" id="question"
									...
									<tr>
										...
										<td><form:input path="answer" id="answer"
												class="form-control" /></td>
										<%--       <td><form:errors path="answer" cssClass="error"/></td> --%>
									</tr>
									<tr>
										<td colspan="3"><input class="btn btn-primary btn-custom"
											type="submit" value="Update" /> <input
											class="btn btn-primary btn-custom" type="reset" value="Reset" /></td>
									</tr>
								</table>
							</form:form>
						</div>
