			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<form method="POST" action="FaceAddJobPoster"
							modelAttribute="register">
							<div class="login-container">
								<div class="loginbox">
									<div class="loginbox-title">Please enter your
										information!</div>
									...
									<div class="form-group">
										<label>Username: <span class="required">*</span></label> <input
											placeholder="" name="name" class="form-control" type="text">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label>Password: <span class="required">*</span></label> <input
											...
											type="password" id="password" onblur="validate()">
									</div>
									<div class="form-group">
										<label>Confirm Password: <span class="required">*</span></label>
										<input placeholder="" class="form-control" type="password" id="retype_password"  onblur="validate()">
									</div>
									<input type="hidden" value=${model } name="faceto" />
									<div class="loginbox-submit">
										<input type="submit" class="btn btn-default btn-block"
											value="Register">
									</div>
									<div class="loginbox-signup">
										Already have account ? <a href="JobPosterLoginForm">Sign
											in</a>
									</div>
								</div>
							</div>
